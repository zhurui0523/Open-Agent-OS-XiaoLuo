...
$shortcutName = ([string][char]0x5C0F) + ([string][char]0x903B) + "Agent OS"
...
$slogan = ([string][char]0x2014) + ([string][char]0x2014) + ([string][char]0x4EE5) + ([string][char]0x610F) + ([string][char]0x56FE) + ([string][char]0x9A71) + ([string][char]0x52A8) + ([string][char]0x7684) + " AI " + ([string][char]0x5DE5) + ([string][char]0x4F5C) + ([string][char]0x53F0)
$shortcut.Description = "$shortcutName $slogan"
$shortcut.Save()
